...
var (
	...
	PrincipalMapping      = map[string]string{
		...
		"did:web:staging.up.web3.storage":     "did:key:z6MkqVThfb3PVdgT5yxumxjFFjoQ2vWd26VUQKByPuSB9N91",
		"did:web:up.web3.storage":             "did:key:z6MkmbbLigYdv5EuU9tJMDXXUudbySwVNeHNqhQGJs7ALUsF",
	}
)
