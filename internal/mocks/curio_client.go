...
// Source: ./pkg/pdp/curio/interface.go
//
// Generated by this command:
//
//	mockgen -source=./pkg/pdp/curio/interface.go -destination=./internal/mocks/curio_client.go -package=mocks
//
...
func (m *MockPDPClient) AddRootsToProofSet(ctx context.Context, id uint64, addRoots []curio.AddRoot) error {
	m.ctrl.T.Helper()
