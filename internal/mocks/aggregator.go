...
// Source: ./pkg/pdp/aggregator/interface.go
//
...
func (m *MockAggregator) AggregatePiece(ctx context.Context, pieceLink piece.PieceLink) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AggregatePiece", ctx, pieceLink)
	ret0, _ := ret[0].(error)
	return ret0
}

// AggregatePiece indicates an expected call of AggregatePiece.
func (mr *MockAggregatorMockRecorder) AggregatePiece(ctx, pieceLink any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AggregatePiece", reflect.TypeOf((*MockAggregator)(nil).AggregatePiece), ctx, pieceLink)
}
